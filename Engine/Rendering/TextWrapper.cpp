...
TextWrapper*
TextWrapper::createText(const EngineRenderingAPI& _renderingAPI, string text, const char *fontPath, int fontSize,
                        SDL_Color color,
                        string textureId) {
...
TextWrapper::TextWrapper(string text, const char *fontPath, int fontSize, SDL_Color color,
