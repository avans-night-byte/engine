...
class KeyMap {
   public:
    inline static std::map<SDL_Keycode, std::string> keyboardMap = {
        {SDLK_UP, "UP"},       {SDLK_DOWN, "DOWN"}, {SDLK_LEFT, "LEFT"},
        {SDLK_RIGHT, "RIGHT"}, {SDLK_w, "UP"},      {SDLK_s, "DOWN"},
        {SDLK_a, "LEFT"},      {SDLK_d, "RIGHT"},   {SDLK_SPACE, "SPACE"},
        {SDLK_e, "E"},         {SDLK_q, "Q"},
    };
    ...
    inline static std::map<SDL_Keycode, std::string> controllerMap = {
