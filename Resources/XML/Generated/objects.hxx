...
{
  /**
   * @name Parsing functions for the %objectList document root.
   */
  //@{
  ...
  objectList_ (const ::std::string& uri,
               ::xml_schema::flags f = 0,
   ...
   */
  ::std::unique_ptr< ::Objects::objectList >
  objectList_ (::xercesc::InputSource& is,
               ::xml_schema::flags f = 0,
               const ::xml_schema::properties& p = ::xml_schema::properties ());
   ...
   */
  ::std::unique_ptr< ::Objects::objectList >
  objectList_ (const ::xercesc::DOMDocument& d,
               ::xml_schema::flags f = 0,
               const ::xml_schema::properties& p = ::xml_schema::properties ());
