...
namespace Walls
{
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // wall
      //
      if (n.name () == "wall" && n.namespace_ () == "Walls")
      {
...
namespace Walls
{
          ...
          const ::xml_schema::properties& p)
  {
    ...
    return ::std::unique_ptr< ::Walls::walls > (
      ::Walls::walls_ (
          ...
          const ::xml_schema::properties& p)
  {
    ...
    ::xsd::cxx::xml::sax::std_input_source isrc (is);
    return ::Walls::walls_ (isrc, h, f, p);
  }
          ...
          const ::xml_schema::properties& p)
  {
    ...
    if (n.name () == "walls" &&
        n.namespace_ () == "Walls")
    {
      ::std::unique_ptr< ::Walls::walls > r (
        ::xsd::cxx::tree::traits< ::Walls::walls, char >::create (
          e, f, 0));
      return r;
    }
         ...
         const ::xml_schema::properties& p)
  {
    ...
    return ::std::unique_ptr< ::Walls::wall > (
      ::Walls::wall_ (
        std::move (d), f | ::xml_schema::flags::own_dom, p));
  }
         ...
         const ::xml_schema::properties& p)
  {
    ...
    if (n.name () == "wall" &&
        n.namespace_ () == "Walls")
    {
      ::std::unique_ptr< ::Walls::wall > r (
        ::xsd::cxx::tree::traits< ::Walls::wall, char >::create (
          e, f, 0));
      return r;
    }
