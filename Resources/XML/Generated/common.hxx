...
namespace Common
{
  ...
  /**
   * @brief Class corresponding to the %text_type schema type.
   *
   * @nosubgrouping
   */
  class text_type: public ::xml_schema::type
  {
    public:
    /**
     * @name dynamic
     *
     * @brief Accessor and modifier functions for the %dynamic
     * optional element.
     */
    //@{
     ...
     * @brief Element type.
     */
    typedef ::xml_schema::string static_type;
     ...
     */
    void
    static_ (::std::unique_ptr< static_type > p);
...
namespace Common
{
  ...
  /**
   * @name Parsing functions for the %text_type document root.
   */
  //@{
  ...
  text_type_ (const ::std::string& uri,
              ::xml_schema::flags f = 0,
              const ::xml_schema::properties& p = ::xml_schema::properties ());
   ...
   */
  ::std::unique_ptr< ::Common::text_type >
  text_type_ (::xercesc::InputSource& is,
              ::xml_schema::flags f = 0,
              const ::xml_schema::properties& p = ::xml_schema::properties ());
   ...
   */
  ::std::unique_ptr< ::Common::text_type >
  text_type_ (const ::xercesc::DOMDocument& d,
              ::xml_schema::flags f = 0,
              const ::xml_schema::properties& p = ::xml_schema::properties ());
